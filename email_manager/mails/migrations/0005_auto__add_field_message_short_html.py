...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.short_html'
        db.add_column(u'mails_message', 'short_html',
                      self.gf('django.db.models.fields.TextField')(default='message takeaway to get displayed'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.short_html'
        db.delete_column(u'mails_message', 'short_html')
    ...
    models = {
        u'mails.message': {
            ...
            'short_html': ('django.db.models.fields.TextField', [], {'default': "'message takeaway to get displayed'"}),
